...
describe("public contract documentation", () => {
  it("keeps release gates and deferred beta boundaries aligned", async () => {
    ...
    expect(projectStatus).toContain("Repository package version: `0.1.0-beta.9`");
    expect(projectStatus).toContain("Published npm `beta`: `0.1.0-beta.9`");
    ...
    expect(projectStatusZh).toContain("仓库 package 版本：`0.1.0-beta.9`");
    expect(projectStatusZh).toContain("npm `beta` 已发布版本：`0.1.0-beta.9`");
