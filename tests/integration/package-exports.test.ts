...
describe("package exports", () => {
  ...
  it("exports the public root API", async () => {
    ...
    expect(api).toMatchObject({
      ...
      shallowReactive: expect.any(Function),
      ...
      SolaceHydrationError: expect.any(Function),
      SolaceTimeoutError: expect.any(Function),
  ...
  it("exports the public DevTools subpath without internal emit helpers", async () => {
    ...
    expect(devtools.DEVTOOLS_CONTRACT_VERSION).toBe(1);
