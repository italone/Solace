...
`0.1.0-beta.6`. The `0.1.0-beta.7` candidate (root `SolaceHydrationError` export) is committed but its npm publish is pending. The beta line adds renderer-owned router SSR on the async renderer entries,
