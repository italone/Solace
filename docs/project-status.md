...
- Streaming SSR, async component SSR, production asset manifest integration, automatic hydration
  mismatch recovery beyond explicit `{ recover: true }`, and router SSR/SSG/hydration integration.
