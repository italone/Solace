...
fallback, the lazy route `"lazy-load-failed"` regression contract, and duplicate current-route
navigation no-op handling. It did not rerun coverage, package smoke outside `pnpm quality`,
