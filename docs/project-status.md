...
line, while published npm `beta` is `0.1.0-beta.6`. The `0.1.0-beta.7` release candidate is committed locally but its npm publish is pending an npm 2FA interaction.
...
- Phase: beta.7 release candidate (2026-08-31), which adds the root `SolaceHydrationError`
