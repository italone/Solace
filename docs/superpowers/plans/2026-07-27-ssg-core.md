...
- [x] **Step 2: Run the targeted tests and smoke check**
...
- [x] **Step 1: Update the project status and roadmap copy**
...
- [x] **Step 1: Re-run the focused server/package checks**

Run: `pnpm vitest run tests/unit/server/generate-static-site.test.ts tests/integration/package-exports.test.ts`

Run: `pnpm package:smoke`

- [x] **Step 2: Run the required public API gates**

Run: `pnpm release:readiness`

Run: `pnpm test:e2e`

- [x] **Step 3: Run the broader local quality gates**

Run: `pnpm quality`

Run: `pnpm release:check`

- [x] **Step 4: Commit any gate-driven fixes**
