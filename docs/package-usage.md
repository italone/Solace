...
query values, string locations must be relative paths, malformed query percent encoding throws a
TypeError, and browser history adapter write targets reject relative/absolute URL-like targets or
hash fragments.
